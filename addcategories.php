...
<head>
  ...
  <title>Little Dreamer Music School - Add New Category</title>
    ...
    <li class="nav-item active">
      ...
      <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item active" href="addcategories.php">Add New Category</a>
      ...
      <div class="container-fluid">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)):
          ...
          if ($stmt->execute($parameters)) {
            ...
            if ($stmt->execute([$newRecordId])) {
              if ($stmt->rowCount() > 0) {
                ...
                <div class="center row">New course category has been added.</div>
                <form method="post">
                  <div class="aligned-form">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="name" value="<?= $record->name ?>" disabled/>
                    </div>
                  </div>
                </form>
                <div class="center row">
                  <a href="categories.php">Back to the course category list</a>
                </div>
              <?php } else {
                echo "Weird, the new client just added has mysteriously disappeared!? ";
                echo '<div class="center row"><a href="categories.php">Back to the course category list</a></div>';
              }
            } else {
          ...
          <form method="post">
            ...
            <div class="form-group">
              <a href="categories.php">Back to Course Categories page</a>
            </div>
          </form>
        <?php endif; ?>
    </div>
