...
<head>
  ...
  <title>Little Dreamer Music School - Register New Student</title>
    ...
    <li class="nav-item active">
      ...
      <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item active" href="addstudents.php">Add New Student</a>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)):
          ...
          if ($stmt->execute($parameters)) {
            ...
            if ($stmt->execute([$newRecordId])) {
              if ($stmt->rowCount() > 0) {
                ...
                <div class="center row">New student has been registered.</div>
                <form method="post">
                  <div class="aligned-form">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" id="firstName" value="<?= $record->firstName ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="surname">Surname</label>
                      <input class="form-control" type="text" id="surname" value="<?= $record->surname ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="address">Address</label>
                      <input class="form-control" type="text" id="address" value="<?= $record->address ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="phone">Phone(+61)</label>
                      <input class="form-control" type="number" id="phone" value="<?= $record->phone ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="dob">DOB</label>
                      <input class="form-control" type="date" id="dob" value="<?= $record->dob ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="email">Email</label>
                      <input class="form-control" type="text" id="email" value="<?= $record->email ?>" disabled/>
                    </div>
                    <div class="form-group">
                      <label for="subscribe">Subscribe</label>
                      <input class="form-control" type="text" id="subscribe" value="<?= $record->subscribe ?>" disabled/>
                    </div>
                  </div>
                </form>
                <div class="center row">
                  <a href="students.php">Back to students page</a>
                </div>
              <?php } else {
                echo "Weird, the new client just added has mysteriously disappeared!? ";
                echo '<div class="center row"><a href="students.php">Back to the students list</a></div>';
              }
            } else {
          ...
          <form method="post">
            <div class="aligned-form">
              <div class="form-group">
                <label for="id">ID</label>
                <input type="number" id="id" value="<?= $nextId ?>" disabled/>
              </div>
              <div class="form-group">
                <label for="firstName">First Name</label>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="subscribe" name="subscribe"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <a href="students.php">Cancel and go back to Students page</a>
            </div>
          </form>
        <?php endif; ?>
